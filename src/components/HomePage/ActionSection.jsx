...
const ActionSection = () => {
  return (
    <div className="max-w-300 mx-auto flex flex-col md:flex-row md:items-start items-center justify-between px-8 `min-md:pl-14` pt-10 bg-linear-to-r from-[#0558FE] to-[#A9CFFF]  rounded-2xl overflow-hidden mt-10">
